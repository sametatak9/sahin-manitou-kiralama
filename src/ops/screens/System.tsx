...
const GROUPS: CredGroup[] = [
  ...
  { id: 'instagram', title: 'Instagram (doğrudan giriş)', apps: 'Instagram gönderi/Reels/hikâye — Facebook sayfası gerekmez', why: 'Instagram’a doğrudan Instagram hesabınızla giriş yapıp botların paylaşım yapabilmesi için.',
    fields: [{ name: 'INSTAGRAM_APP_ID', label: 'Instagram uygulama kimliği', secret: false, placeholder: '1234567890' }, { name: 'INSTAGRAM_APP_SECRET', label: 'Instagram uygulama gizli anahtarı', secret: true }],
    steps: ['developers.facebook.com → uygulamanız → Ürün ekle → “Instagram” → Kur.', 'Instagram → “Instagram girişi ile API kurulumu” sayfası: “Instagram uygulama kimliği” ve “Instagram uygulama gizli anahtarı”nı (Göster’e basıp tamamını) buraya yapıştırın. Dikkat: bunlar Facebook uygulama kimliğinden FARKLIDIR.', 'Aynı sayfada “İşletme girişini ayarla” → “OAuth yönlendirme URI’leri” alanına aşağıdaki adresi ekleyin → kaydedin.', 'Aynı sayfada “Instagram test kullanıcısı / hesap ekle” ile kendi Instagram hesabınızı ekleyip Instagram’dan daveti kabul edin.', 'Instagram hesabınız Profesyonel hesap olmalı (Ayarlar → Hesap türü).'],
    link: { href: 'https://developers.facebook.com/apps/', label: 'Meta geliştirici paneli' }, redirect: true },
  ...
  { id: 'tavily', title: 'Web araması (Tavily)', apps: 'Botların internette gerçek arama yapması', why: 'Bu olmadan botlar yalnızca haber akışına bakabilir. Ayda 1000 arama ücretsiz, kart gerekmez.',
    fields: [{ name: 'TAVILY_API_KEY', label: 'Tavily API anahtarı', secret: true, placeholder: 'tvly-…' }],
    steps: ['app.tavily.com adresine girin → Google ile üye olun.', 'Açılan sayfadaki “API Keys” bölümünde “tvly-” ile başlayan anahtarı kopyalayın.', 'Buraya yapıştırıp Kaydet’e basın.'], link: { href: 'https://app.tavily.com/home', label: 'Tavily paneli' } },
