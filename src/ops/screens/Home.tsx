        ...
        <div className="relative flex flex-col lg:flex-row lg:items-end justify-between gap-5">
          <div>
            ...
            <p className="text-sm text-ink-300 mt-1 max-w-2xl">
              Bugün <b className="text-ink-100">{d.tasks.length}</b> planlı bot görevi, <b className="text-ink-100">{d.runs.length}</b> tamamlanan/çalışan koşu ve <b className="text-amber-300">{d.pendingCount}</b> onay bekleyen iş var.
            </p>
          </div>
