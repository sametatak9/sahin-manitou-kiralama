...
export const TONE_CLASSES: Record<Tone, string> = {
  go: 'bg-emerald-500/12 text-emerald-700 ring-emerald-400/30',
  wait: 'bg-amber-500/12 text-amber-700 ring-amber-400/30',
  run: 'bg-sky-500/12 text-sky-700 ring-sky-400/30',
  stop: 'bg-rose-500/12 text-rose-700 ring-rose-400/30',
  idle: 'bg-slate-500/10 text-slate-600 ring-slate-400/30',
  info: 'bg-violet-500/12 text-violet-700 ring-violet-400/30',
};
