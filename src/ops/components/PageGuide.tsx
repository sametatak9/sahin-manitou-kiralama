...
const GUIDE: Partial<Record<Route, { what: string; tips: string[] }>> = {
  ...
  reports: { what: 'Botların bitirdiği tüm görevler ve raporlar.', tips: ['Görevi açın → “Onayla ve kaydet” ile sonucu kalıcı listeye alın.', 'PDF kaydet ve WhatsApp ile gönder butonları raporun altında.'] },
  ...
  construction: { what: 'İnşaat (kentsel dönüşüm, konut) müşterileriniz.', tips: ['Kartı sürükleyip aşamasını değiştirin; her değişiklik tarihli kaydedilir.'] },
  rental: { what: 'Makine kiralama (Manitou) müşterileriniz.', tips: ['Müşteriyi açın → not ekleyin veya WhatsApp takip mesajı hazırlayın.'] },
